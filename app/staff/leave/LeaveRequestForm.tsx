                    ...
                    <Select>
                            ...
                            <SelectContent>
                                <SelectGroup>
                                    ...
                                    <SelectItem value="pineapple">Sick Leave</SelectItem>
                                    <SelectItem value="apple">Maternity Leave</SelectItem>
                                    <SelectItem value="banana">Vacation Leave</SelectItem>
                                    <SelectItem value="blueberry">Bonus Leave</SelectItem>
                                    <SelectItem value="grapes">Paternity Leave</SelectItem>
                                </SelectGroup>
                            </SelectContent>
                        </Select>
                    </div>
